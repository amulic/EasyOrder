...
namespace EasyOrder.API.Migrations
{
    ...
    [Migration("20231207221117_Connecting User with Admin and Employee")]
    partial class ConnectingUserwithAdminandEmployee
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EasyOrder.API.Models.Domain.Administrator", b =>
                {
                    b.HasOne("EasyOrder.API.Models.Domain.User", "User")
                        ...
                        .HasForeignKey("EasyOrder.API.Models.Domain.Administrator", "UserId")
            ...
            modelBuilder.Entity("EasyOrder.API.Models.Domain.Employee", b =>
                {
                    b.HasOne("EasyOrder.API.Models.Domain.User", "User")
                        .WithOne("Employee")
                        .HasForeignKey("EasyOrder.API.Models.Domain.Employee", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
